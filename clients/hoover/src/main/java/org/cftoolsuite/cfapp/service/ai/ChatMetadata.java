...
/**
 * Contains metadata about a chat response, such as token counts, response time,
 * and model used.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public record ChatMetadata(Integer inputTokens, Integer outputTokens, Integer totalTokens, String responseTime,
		Double tokensPerSecond, String model) {
