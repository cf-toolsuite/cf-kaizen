...
/**
 * Wrapper for chat response data that includes both content and metadata. Used
 * to send content chunks or metadata in the stream.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public record ChatResponse(String content, ChatMetadata metadata, boolean isMetadata) {
	/**
